...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            ...
            <label>所属单位:</label>
            <select id="search-part" class="easyui-combobox" panelHeight="auto" style="width:120px">
            	<option value="-1">全部</option>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td width="60" align="right">头像:</td>
                <td><input type="text" id="edit-photo" name="photo" value="/lab/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
                <td width="60" align="right">用户名:</td>
            ...
            <tr>
                <td width="60" align="right">所属单位:</td>
                <td>
                	<select id="edit-pId" name="pId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择单位'">
		                <c:forEach items="${roleList }" var="role">
		                <option value="${role.id }">${role.name }</option>
		                </c:forEach>
		            </select>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'pid',title:'所属单位',width:100,formatter:function(value,row,index){
				var partList = $("#search-part").combobox('getData');
				for(var i=0;i<partList.length;i++){
					if(value == partList[i].value)return partList[i].text;
				}
				return value;
			}},
